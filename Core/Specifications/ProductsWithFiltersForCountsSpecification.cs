...
{
    public class ProductsWithFiltersForCountsSpecification : BaseSpecification<Product>
    {
        public ProductsWithFiltersForCountsSpecification(ProductsSpecParams productsSpecParams)  : base(x =>
